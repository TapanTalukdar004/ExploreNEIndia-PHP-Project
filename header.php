...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars($page_specific_css); ?>">
    <?php endif; ?>
        ...
        <nav>
            <div class="navbar-container">
                ...
                <div class="nav-action-area">
                    ...
                    <a href="account.php" class="btn username-btn" title="My Account">
                            <i class="fas fa-user-circle"></i> <!-- Optional icon -->
